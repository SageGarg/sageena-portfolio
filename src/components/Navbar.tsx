...
export default function NavBar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-20 max-w-5xl items-center gap-6 overflow-hidden px-4 py-3">
        {/* —— Left-side brand / home link —— */}
        <Link
          href="/"
          className="shrink-0 whitespace-nowrap text-base font-semibold tracking-tight text-gray-900
        ...
        <div className="flex min-w-0 flex-1 items-center gap-6 overflow-x-auto whitespace-nowrap">
          {links.map(({ href, label }) => (
            <Link
              ...
              className={clsx(
                "relative shrink-0 px-1 text-sm font-medium transition-colors",
                isActive(href)
                  ? "text-pink-700"
